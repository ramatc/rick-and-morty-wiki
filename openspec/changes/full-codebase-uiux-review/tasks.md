...
- [x] 4.4 Update `NotFound` with context-aware `message` prop; style `ErrorState` with `--color-danger` and hole/portal motif
- [x] 4.5 Add inline "searching…" indicator near search box during debounce
